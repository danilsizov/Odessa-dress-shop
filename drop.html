...
<div class="container">
	<div class="row my-small-text accent-text-color nav-margin-top bot-line nav-padding">
		...
		<div class="col-lg-7">
			<div class="row">
				...
				<a href="#" class="but-nav-top accent-text-color">Поиск</a>
				<a href="sign-in.html" class="but-nav-top accent-text-color">Войти</a>
				<a href="drop.html" class="but-nav-top accent-text-color">Сотрудничество</a>
				<a href="my-order.html" class="but-nav-top accent-text-color">
				Моя корзина <img src="image/bug.png">
				</a>
				<a href="#" class="but-nav-top accent-text-color dropmy" onclick="myMoneyFunction()">UAH</a>
				<div id="Money" class="dropdown-content let-mar-prod">
	...
	<div class="row">
	<div class="col-lg-4">
		<img src="image/black.png" width="35%">
	</div>
	<div class="col-lg-8">
...
<div class="row nav-margin-top50">
	<div class="small-line"><strong>Главная</strong></div><div class="black-box"><strong>Дроп Шоппинг</strong></div>
</div>
</div>


<div class="row bot-line-pink nav-margin-top50">
<div class="container">
<a href="shop.html"><div class="but-popular accent-color nav-margin-top text-center float-left"> < Каталог</div></a>
	<div class="block-big-text accent-text-color text-center text-center my-tittle">Дроп Шоппинг</div>
...
<div class="col-lg-6 right-line">
	<div class="block-big-text accent-text-color">Постоянные клиенты</div>
	<div class="my-prise">
	<p class="mylatotext nav-margin-top30">e-mail</p>
	<div class="input-group">
	  <input type="text" class="form-control" placeholder="Username">
	</div>
	<p class="mylatotext nav-margin-top30">Пароль</p>
	<div class="input-group">
	  <input type="text" class="form-control" placeholder="Username">
	</div>
	<a href="#"><div class="but-popular accent-color nav-margin-top text-center float-left block-small-text"> Войти</div></a>
	</div>

</div>
<div class="col-lg-6">
	<div class="block-big-text accent-text-color">Новый клиент</div>
	<div class="my-prise">
	<div class="float-left">
	<p class="mylatotext nav-margin-top30">Ф.И.О</p>
	<div class="input-group">
	  <input type="text" class="form-control" placeholder="Username">
	</div>
	</div>
	<div class="float-left">
	<p class="mylatotext nav-margin-top30">Страна, область, город.</p>
	<div class="input-group">
	  <input type="text" class="form-control" placeholder="Username">
	</div>
	</div>
	<p>
	<div class="float-left">
	<p class="mylatotext nav-margin-top30">Телефон</p>
	<div class="input-group">
	  <input type="text" class="form-control" placeholder="Username">
	</div>
	</div>
	...
	<div class="float-left">
	<p class="mylatotext nav-margin-top30">Подтвердите пароль</p>
	<div class="input-group">
	  <input type="text" class="form-control" placeholder="Username">
	</div>
	</div>
