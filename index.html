	...
	<div class="col-lg-10">
		...
		<div class="col-lg-10">
			<div class="row">
				...
				<img src="image/search.png" width="24px"><a href="#" class="accent-text-color"><strong>____________________</strong></a> | <a href="my-order.html" class="but-nav-top accent-text-color"><strong>Моя корзина</strong></a><img src="image/shop_cart.png" width="20px">
